...
preprocessing_layer = tf.keras.layers.Lambda(tf.keras.applications.efficientnet_v2.preprocess_input)(flipping_layer)
...
output = tf.keras.layers.Dense(12, activation = 'sigmoid')(avg)
...
model_checkpoint = tf.keras.callbacks.ModelCheckpoint("/content/drive/MyDrive/Thermal Imaging Project/Greyscale Images/Transfer Learning Model Using EfficientNetV2B3.keras", save_best_only = True, monitor = "val_binary_accuracy")
...
model = tf.keras.models.load_model("/content/drive/MyDrive/Thermal Imaging Project/Greyscale Images/Transfer Learning Model Using EfficientNetV2B3.keras", custom_objects={'preprocess_input': tf.keras.applications.efficientnet_v2.preprocess_input})

model.evaluate(val_ds)

for layer in model.layers[2].layers[402:]:
...
model.save("/content/drive/MyDrive/Thermal Imaging Project/Greyscale Images/Transfer Learning Model Using EfficientNetV2B3.keras")
