...
preprocessing_layer = tf.keras.layers.Lambda(tf.keras.applications.resnet.preprocess_input)(flipping_layer)
...
model_checkpoint = tf.keras.callbacks.ModelCheckpoint("/content/drive/MyDrive/Thermal Imaging Project/Greyscale Images/Transfer Learning Model Using ResNet50.keras", save_best_only = True, monitor = "val_binary_accuracy")
...
model = tf.keras.models.load_model("/content/drive/MyDrive/Thermal Imaging Project/Greyscale Images/Transfer Learning Model Using ResNet50.keras", custom_objects={'preprocess_input': tf.keras.applications.inception_v3.preprocess_input})

model.evaluate(test_ds)

model.layers[2].layers[-19].trainable = True

model.layers[2].layers[-20].trainable = True
...
model.save("/content/drive/MyDrive/Thermal Imaging Project/Greyscale Images/Transfer Learning Model Using ResNet50.keras")
